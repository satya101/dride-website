	...
	appActions = [
		{
			...
			video: 'upload',
			desc:
				'Upload and share your videos with just one press of the Dride-Zero impulse button, or use our app to search for specific events, find the footage and share. Yes, it’s really that simple.'
		},
		{
			icon: 'icon-f_share',
			title: 'Share',
		...
		},
		{
			...
			video: 'settings',
			desc:
				'Managing your device settings with our state of the art Dride app is easy, so adjusting frame rate, video resolution, sharing preferences and other options is fast, efficient and centralized, no fiddling with funny camera buttons required.'
		}
	];
